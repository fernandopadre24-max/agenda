...
export function RegisterForm() {
  ...
  function onSubmit(data: RegisterFormValues) {
    ...
    // Por enquanto, vamos apenas exibir uma notificação e redirecionar.
    console.log(data);
    toast({
                  ...
                  <FormControl>
                    ...
                    >
                      <FormItem className="flex items-center space-x-2 space-y-0">
                        <FormControl>
                          <RadioGroupItem value="contratante" />
                        </FormControl>
                      ...
                      <FormItem className="flex items-center space-x-2 space-y-0">
                        <FormControl>
                          <RadioGroupItem value="artista" />
                        </FormControl>
                        <FormLabel className="font-normal">Artista</FormLabel>
                      </FormItem>
                    </RadioGroup>
                  </FormControl>
                  <FormMessage />
